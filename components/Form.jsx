...
const Form = props => {
  return (
    <section className='w-full max-w-full flex-start flex-col'>
      ...
      <p className='desc text-left max-w-md'>{props.type} and share amazing prompts with the world and let your imagination run wild with any AI-powered platform</p>
